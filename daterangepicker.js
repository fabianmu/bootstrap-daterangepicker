        ...
        DateRangePicker.prototype = {
            ...
            setOptions: function(options, callback) {
                ...
                if (typeof options.ranges === 'object') {
                    ...
                    if(this.showCustomRangeLabel === true) {
            ...
            showCalendars: function() {
                if(this.showCustomRangeLabel === false) {
                    return;
                }
                this.container.addClass('show-calendar');
                this.move();
            ...
            updateCalendars: function () {
                ...
                for (var range in this.ranges) {
                    if (this.timePicker) {
                        ...
                        //console.log('this.startDate ' + this.startDate.format('YYYY-MM-DD'));
                        //console.log('this.range start: ' + this.ranges[range][0].format('YYYY-MM-DD'));
                        //console.log('this.startDate ' + this.endDate.format('YYYY-MM-DD'));
                        //console.log('this.range end: ' + this.ranges[range][1].format('YYYY-MM-DD'));
                        //ignore times when comparing dates if time picker is not enabled
                        // if (range === this.chosenLabel && this.startDate.format('YYYY-MM-DD') == this.ranges[range][0].format('YYYY-MM-DD') && this.endDate.format('YYYY-MM-DD') == this.ranges[range][1].format('YYYY-MM-DD')) {
